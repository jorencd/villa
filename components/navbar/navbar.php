...
<body>
  <nav id="navbar" class="navbar navbar-expand-md fixed-top z-3">
    <div class="container-fluid">
      <!-- Brand -->
      <div class="order-2 mx-auto">
        <a class="navbar-brand" href="#">
          <img class="img-fluid" src="../../assets/image/logo-white.png" alt="Logo" width="50" height="45"
      ...
      <!-- Toggler -->
      <div class="order-1">
        <button class="navbar-toggler shadow-none ps-0 pe-5 pe-md-0 me-5 me-md-0 border-0" type="button"
      ...
      <!-- Offcanvas Menu -->
      <div class="offcanvas offcanvas-start order-3" tabindex="-1" id="offcanvasNavbar"
        aria-labelledby="offcanvasNavbarLabel">
        <div class="offcanvas-header">
          <h5 class="offcanvas-title" id="offcanvasNavbarLabel">Menu</h5>
          <button type="button" class="btn shadow-none me-auto" data-bs-dismiss="offcanvas" aria-label="Close">
        ...
        <div class="offcanvas-body">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item dropdown">
              <a class="nav-link d-flex align-items-center" href="#experience" id="experienceDropdown" role="button"
